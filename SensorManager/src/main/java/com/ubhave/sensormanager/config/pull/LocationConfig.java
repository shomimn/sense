...
public class LocationConfig
{
	...
	public static final long DEFAULT_SAMPLING_WINDOW_SIZE_MILLIS = 6000;
	public static final long DEFAULT_SLEEP_INTERVAL = 60000;
	public final static int LOCATION_CHANGE_DISTANCE_THRESHOLD = 2;
	...
	public static SensorConfig getDefault()
	{
		...
		sensorConfig.setParameter(LocationConfig.ACCURACY_TYPE, LOCATION_ACCURACY_FINE);
		return sensorConfig;
	}
}
